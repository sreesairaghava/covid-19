  ...
  return (
    <div className={styles.container}>
      {/* {provinceData.length > 1 ? (
        <h3>Statewise Data for {country.country}</h3>
      ) : (
        <h3>Statewise Data for {country.country} is not Available</h3>
      )} */}
      {provinceData.length > 1 ? (
              ...
              {provinceData.length > 1
                ? provinceData.map((data) => (
                    <StyledTableRow key={data.provinceState}>
                      ...
                      <StyledTableCell
                        style={{ color: "rgba(0, 139, 139, 0.8)" }}
                        align="left"
                      >
                        {data.confirmed}
                      </StyledTableCell>
